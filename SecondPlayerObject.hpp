...
class SecondPlayerObject : public GameObject {
public:
    SecondPlayerObject();
    SecondPlayerObject(float mass, const glm::vec3& pos = glm::vec3(0.f),
...
private:
    ...
    long long left_right, up_down, check_collision, check_trigger, 
        check_collectable, animation;
};